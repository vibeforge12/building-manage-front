...
class _ApiTestWidgetState extends ConsumerState<ApiTestWidget> {
  ...
  Future<void> _testHeadquartersLogin() async {
    setState(() {
      _isLoading = true;
      _result = null;
    });
    ...
    try {
      ...
      // 본사 로그인 테스트
      final result = await authDataSource.loginHeadquarters(
        username: "kcjco",
        password: "11111111",
      );
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          ElevatedButton(
            onPressed: _isLoading ? null : _testHeadquartersLogin,
            child: const Text('본사 로그인 테스트'),
          ),
          const SizedBox(height: 16),
