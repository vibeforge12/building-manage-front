...
> **관례 파일** · 저장소 안내. 전체 문서 목록은 [`../docs/README.md`](../docs/README.md),
> 문서 규칙은 [`../docs/문서체계.md`](../docs/문서체계.md) 를 보십시오.
...
| `docs/코드지도.md` | 앱 코드 구조 실측 |
| `../docs/3-할일/부채.md` | 미해결 이슈 (P0~P3) |
| `docs/배포_가이드.md` | Fastlane 기반 스토어 배포 절차 |
| `docs/FCM연동.md` | 푸시 알림 연동 (공고문 푸시 미반영) |
